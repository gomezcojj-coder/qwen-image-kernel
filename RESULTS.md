...
phenomenon the vLLM-Omni recipe measures (26.1 dB for all-layers FP8 on GB200); our per-prompt range is 21-37 dB with edits highest (the reference conditioning
anchors the output).
